...
public class MatriculaController {
	...
	public String deleteMatricula(@PathVariable(value = "id") Long id,RedirectAttributes flashMessage) {
		matriculaService.deleteMatricula(id);
		flashMessage.addFlashAttribute("message", "Se elimino la matricula exitosamente");
